...
casename = "basic_newloss_rl_ens";
resname = ["basic_newloss_rl_e5", "basic_newloss_rl_e10", "basic_newloss_rl_e20","basic_newloss_rl_e40","basic_newloss_rl_e80"];


inf_cfg = [ 5, 10,20,40,80];
