...
ax = gca;
ax.FontSize=24;
saveas(gcf, 'F:\BaiduNetdiskWorkspace\论文写作\MWR\mlp_inflation\MWR_V6.1\fig\imr_a09_rank.png', 'png');
...
for i=1:20
    ...
    ax = gca;
    ax.FontSize=24;
    saveas(gcf, sprintf("F:\\BaiduNetdiskWorkspace\\论文写作\\MWR\\mlp_inflation\\MWR_V6.1\\fig\\imr_epoch%02d_rank.png", i), 'png');
    clf
end
