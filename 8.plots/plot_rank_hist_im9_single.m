...
case_no=5;
gs_casename='basic_newloss_im9_rl_gs';
...
ax = gca;
ax.FontSize=24;
saveas(gcf, 'F:\BaiduNetdiskWorkspace\论文写作\MWR\mlp_inflation\MWR_V6.1\fig\im9_a09_rank.png', 'png');
...
for i=1:20
    ...
    ax = gca;
    ax.FontSize=24;
    saveas(gcf, sprintf("F:\\BaiduNetdiskWorkspace\\论文写作\\MWR\\mlp_inflation\\MWR_V6.1\\fig\\im9_epoch%02d_rank.png", i), 'png');
    clf
end
