...
resname = "basic_newloss_imr_rl_fwd";
for file_cnt = 1:1
        ...
        for i = 1: handles.model_size
            ...
            for j = 1: handles.model_size
                ...
                upd_inf = update_inflate( mean(obs_prior), var(obs_prior), obs(i), obs_error_var, ...
                   prior_inf(j), upd_inf, handles.inflation_Std, handles.inflation_Min, handles.inflation_Max, ...
...
%% ----------------------------------------------------------------------
    ...
    function h = initialize_data(init_flag,loop)
        ...
        handles.inflation_Std =0.22;
        handles.inflation_Min     = 1;
        handles.inflation_Max     = 20;
        handles.inflation_Std_Min = 0;
