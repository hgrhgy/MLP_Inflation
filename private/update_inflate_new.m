function [new_cov_inflate, new_cov_inflate_sd] = update_inflate_new(x_p, r_var, y_o, sigma_o_2, ss_inflate_base, lambda_mean, lambda_sd, ...
...
elseif strcmp(flavor, 'Gaussian_MLP')
    theta_bar_2  = ( 1 + gamma_corr * (sqrt(lambda_mean) - 1) )^2 * sigma_p_2 + sigma_o_2;
end
